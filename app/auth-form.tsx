...
export default function AuthForm({ endpoint, fields, submitLabel }: AuthFormProps) {
  ...
  return <form onSubmit={(event) => { event.preventDefault(); void submit(new FormData(event.currentTarget)); }} className="flex w-full max-w-sm flex-col gap-4 rounded-xl border border-zinc-800 bg-zinc-900 p-6 text-zinc-100">
