...
import { authorizeAdminRequest, badRequest } from "../../delivery";
...
export async function POST(request: Request, { params }: Context) {
  ...
  switch (result.kind) {
    ...
    case "shared_identity_reset_forbidden": case "forbidden": return NextResponse.json({ error: "Forbidden." }, { status: 403 });
