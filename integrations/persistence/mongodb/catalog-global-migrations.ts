...
export const globalCatalogIndexes = {
  ...
  provider_connections_v2: [unique({ id: 1 }, "provider_connections_v2_id_unique"), { key: { providerId: 1, enabled: 1 }, options: { name: "provider_connections_v2_enabled_lookup" } }, { key: { providerId: 1 }, options: { unique: true, partialFilterExpression: { enabled: true }, name: "provider_connections_v2_one_enabled_unique" } }],
